...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(noiseMap), TextureGenerator.TextureFromColorMap(colorMap, mapWidth, mapHeight));//hand over meshData and ColorMap and Size
        }
    }
